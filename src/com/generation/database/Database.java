...
public class Database {
    ...
    private Database(){
        ...
        //indirizzo al server mysql, alla sua porta e allo specifico schema a cui connettersi
        //jdbc:mysql è il protocollo che indica a jdbc quale driver servirà per relazionarsi con 
        //il DBMS, nel nostro caso è mysql per cui quando si passa questo indirizzo JDBC 
        //cerca automaticamente tra i driver importati con il jar quello specifico indicato qui
        //e lo carica a RUNTIME fornendo gli strumenti necessari per collegarsi con il DBMS corretto
